...
var require$$0$7 = (_wks && typeof _wks === 'object' && 'default' in _wks ? _wks['default'] : _wks);

var _wksExt = __commonjs(function (module, exports) {
exports.f = require$$0$7;
});

var require$$0$6 = (_wksExt && typeof _wksExt === 'object' && 'default' in _wksExt ? _wksExt['default'] : _wksExt);
...
var require$$0$8 = (_hide && typeof _hide === 'object' && 'default' in _hide ? _hide['default'] : _hide);

var _objectGops = __commonjs(function (module, exports) {
exports.f = Object.getOwnPropertySymbols;
});

var require$$1$4 = (_objectGops && typeof _objectGops === 'object' && 'default' in _objectGops ? _objectGops['default'] : _objectGops);
...
var require$$1$7 = (_toInteger && typeof _toInteger === 'object' && 'default' in _toInteger ? _toInteger['default'] : _toInteger);

var _toIndex = __commonjs(function (module) {
var toInteger = require$$1$7
  , max       = Math.max
  , min       = Math.min;
...
var require$$1$11 = (_cof && typeof _cof === 'object' && 'default' in _cof ? _cof['default'] : _cof);

var _iobject = __commonjs(function (module) {
// fallback for non-array-like ES3 and non-enumerable old V8 strings
var cof = require$$1$11;
module.exports = Object('z').propertyIsEnumerable(0) ? Object : function(it){
  return cof(it) == 'String' ? it.split('') : Object(it);
};
});

var require$$1$10 = (_iobject && typeof _iobject === 'object' && 'default' in _iobject ? _iobject['default'] : _iobject);

var _toIobject = __commonjs(function (module) {
// to indexed object, toObject with fallback for non-array-like ES3 strings
var IObject = require$$1$10
...
var require$$1$9 = (_toIobject && typeof _toIobject === 'object' && 'default' in _toIobject ? _toIobject['default'] : _toIobject);

var _arrayIncludes = __commonjs(function (module) {
// false -> Array#indexOf
// true  -> Array#includes
var toIObject = require$$1$9
...
var require$$0$14 = (_objectGopd && typeof _objectGopd === 'object' && 'default' in _objectGopd ? _objectGopd['default'] : _objectGopd);
...
var require$$0$15 = (_objectCreate && typeof _objectCreate === 'object' && 'default' in _objectCreate ? _objectCreate['default'] : _objectCreate);
...
var require$$1$14 = (_aFunction && typeof _aFunction === 'object' && 'default' in _aFunction ? _aFunction['default'] : _aFunction);

var _ctx = __commonjs(function (module) {
// optional / simple context binding
var aFunction = require$$1$14;
...
var require$$1$13 = (_export && typeof _export === 'object' && 'default' in _export ? _export['default'] : _export);
...
if(!USE_NATIVE){
  ...
  require$$1$4.f = $getOwnPropertySymbols;
...
$Symbol[PROTOTYPE][TO_PRIMITIVE] || require$$0$8($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
...
var require$$1$16 = (_iterators && typeof _iterators === 'object' && 'default' in _iterators ? _iterators['default'] : _iterators);
...
var require$$1$18 = (_toObject && typeof _toObject === 'object' && 'default' in _toObject ? _toObject['default'] : _toObject);

var _objectGpo = __commonjs(function (module) {
// 19.1.2.9 / 15.2.3.2 Object.getPrototypeOf(O)
var has         = require$$2$2
  , toObject    = require$$1$18
  , IE_PROTO    = require$$0$11('IE_PROTO')
  , ObjectProto = Object.prototype;
...
var require$$1$17 = (_objectGpo && typeof _objectGpo === 'object' && 'default' in _objectGpo ? _objectGpo['default'] : _objectGpo);

var _iterCreate = __commonjs(function (module) {
'use strict';
var create         = require$$0$15
  , descriptor     = require$$3$2
  , setToStringTag = require$$3$5
  , IteratorPrototype = {};

// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
require$$0$8(IteratorPrototype, require$$0$7('iterator'), function(){ return this; });
...
var LIBRARY        = require$$19
  ...
  , hide           = require$$0$8
  , has            = require$$2$2
  , Iterators      = require$$1$16
  , $iterCreate    = require$$3$6
  , setToStringTag = require$$3$5
  , getPrototypeOf = require$$1$17
...
var require$$0$17 = (_iterDefine && typeof _iterDefine === 'object' && 'default' in _iterDefine ? _iterDefine['default'] : _iterDefine);
...
module.exports = require$$0$17(Array, 'Array', function(iterated, kind){
...
var require$$1$19 = (_stringAt && typeof _stringAt === 'object' && 'default' in _stringAt ? _stringAt['default'] : _stringAt);

var es6_string_iterator = __commonjs(function (module) {
'use strict';
var $at  = require$$1$19(true);

// 21.1.3.27 String.prototype[@@iterator]()
require$$0$17(String, 'String', function(iterated){
...
module.exports = require$$0$6.f('iterator');
});

var require$$0$16 = (iterator$1 && typeof iterator$1 === 'object' && 'default' in iterator$1 ? iterator$1['default'] : iterator$1);
...
var require$$0 = (_typeof && typeof _typeof === 'object' && 'default' in _typeof ? _typeof['default'] : _typeof);
...
var $export = require$$1$13;
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !require$$1, 'Object', {defineProperty: require$$2.f});
});
...
var require$$0$19 = (defineProperty$1 && typeof defineProperty$1 === 'object' && 'default' in defineProperty$1 ? defineProperty$1['default'] : defineProperty$1);

var defineProperty = __commonjs(function (module) {
module.exports = { "default": require$$0$19, __esModule: true };
});

var require$$0$18 = (defineProperty && typeof defineProperty === 'object' && 'default' in defineProperty ? defineProperty['default'] : defineProperty);
...
var _defineProperty = require$$0$18;
...
var require$$0$21 = (runtime && typeof runtime === 'object' && 'default' in runtime ? runtime['default'] : runtime);
...
var require$$0$20 = (runtimeModule && typeof runtimeModule === 'object' && 'default' in runtimeModule ? runtimeModule['default'] : runtimeModule);
...
var require$$0$24 = (_iterDetect && typeof _iterDetect === 'object' && 'default' in _iterDetect ? _iterDetect['default'] : _iterDetect);
...
var require$$2$3 = (_setSpecies && typeof _setSpecies === 'object' && 'default' in _setSpecies ? _setSpecies['default'] : _setSpecies);
...
if(!setTask || !clearTask){
  ...
  // Node.js 0.8-
  if(require$$1$11(process) == 'process'){
    defer = function(id){
...
var require$$1$20 = (_task && typeof _task === 'object' && 'default' in _task ? _task['default'] : _task);

var _microtask = __commonjs(function (module) {
var global    = require$$1$2
  , macrotask = require$$1$20.set
  , Observer  = global.MutationObserver || global.WebKitMutationObserver
  , process   = global.process
  , Promise   = global.Promise
  , isNode    = require$$1$11(process) == 'process';
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = require$$5(Function.call, require$$0$14.f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var require$$0$25 = (_setProto && typeof _setProto === 'object' && 'default' in _setProto ? _setProto['default'] : _setProto);
...
var require$$3$8 = (_classof && typeof _classof === 'object' && 'default' in _classof ? _classof['default'] : _classof);

var core_getIteratorMethod = __commonjs(function (module) {
var classof   = require$$3$8
  , ITERATOR  = require$$0$7('iterator')
  , Iterators = require$$1$16;
...
var require$$0$26 = (core_getIteratorMethod && typeof core_getIteratorMethod === 'object' && 'default' in core_getIteratorMethod ? core_getIteratorMethod['default'] : core_getIteratorMethod);

var _isArrayIter = __commonjs(function (module) {
// check on default Array iterator
var Iterators  = require$$1$16
  , ITERATOR   = require$$0$7('iterator')
...
var require$$4$5 = (_iterCall && typeof _iterCall === 'object' && 'default' in _iterCall ? _iterCall['default'] : _iterCall);
...
var LIBRARY            = require$$19
  ...
  , forOf              = require$$10
  , setProto           = require$$0$25.set
  , speciesConstructor = require$$8$1
  , task               = require$$1$20.set
  , microtask          = require$$6()
  , PROMISE            = 'Promise'
...
var USE_NATIVE = !!function(){
  try {
    ...
    var promise     = $Promise.resolve(1)
      , FakePromise = (promise.constructor = {})[require$$0$7('species')] = function(exec){ exec(empty, empty); };
...
$export($export.S + $export.F * !(USE_NATIVE && require$$0$24(function(iter){
...
var require$$0$23 = (promise$1 && typeof promise$1 === 'object' && 'default' in promise$1 ? promise$1['default'] : promise$1);

var promise = __commonjs(function (module) {
module.exports = { "default": require$$0$23, __esModule: true };
});

var require$$0$22 = (promise && typeof promise === 'object' && 'default' in promise ? promise['default'] : promise);
...
var $export = require$$1$13
// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
$export($export.S, 'Object', {create: require$$0$15});
});
...
var require$$1$21 = (create && typeof create === 'object' && 'default' in create ? create['default'] : create);

var es6_object_setPrototypeOf = __commonjs(function (module) {
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $export = require$$1$13;
$export($export.S, 'Object', {setPrototypeOf: require$$0$25.set});
});
...
var DataLoader = function () {
  ...
  _createClass(DataLoader, [{
    ...
    key: 'getSubjects',
    value: function () {
      var ref = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(amount, position, referenceSubj, fromDate, toDate) {
        var params, subjectsLoaded;
    ...
    key: 'load',
    value: function () {
      var ref = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3(params, ajaxFunc) {
...
var AvailabilityCalendar = function () {
  ...
  _createClass(AvailabilityCalendar, [{
    key: 'setCredentials',
    value: function setCredentials(credentials) {
      assert((typeof credentials === 'undefined' ? 'undefined' : require$$0(credentials)) === 'object', credentials + ' is not an object');
