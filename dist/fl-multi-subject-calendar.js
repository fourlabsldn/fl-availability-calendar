...
var require$$17$1 = (_library && typeof _library === 'object' && 'default' in _library ? _library['default'] : _library);

var _wksDefine = __commonjs(function (module) {
var global         = require$$1$2
  , core           = require$$0$3
  , LIBRARY        = require$$17$1
  , wksExt         = require$$0$5
...
var require$$1$15 = (_aFunction && typeof _aFunction === 'object' && 'default' in _aFunction ? _aFunction['default'] : _aFunction);

var _ctx = __commonjs(function (module) {
// optional / simple context binding
var aFunction = require$$1$15;
...
var require$$1$14 = (_ctx && typeof _ctx === 'object' && 'default' in _ctx ? _ctx['default'] : _ctx);
...
var require$$1$17 = (_iterators && typeof _iterators === 'object' && 'default' in _iterators ? _iterators['default'] : _iterators);
...
var require$$1$19 = (_toObject && typeof _toObject === 'object' && 'default' in _toObject ? _toObject['default'] : _toObject);

var _objectGpo = __commonjs(function (module) {
// 19.1.2.9 / 15.2.3.2 Object.getPrototypeOf(O)
var has         = require$$2$3
  , toObject    = require$$1$19
  , IE_PROTO    = require$$0$10('IE_PROTO')
  , ObjectProto = Object.prototype;
...
var require$$1$18 = (_objectGpo && typeof _objectGpo === 'object' && 'default' in _objectGpo ? _objectGpo['default'] : _objectGpo);
...
require$$0$7(IteratorPrototype, require$$0$6('iterator'), function(){ return this; });
...
'use strict';
var LIBRARY        = require$$17$1
  , $export        = require$$1$13
  , redefine       = require$$7
  , hide           = require$$0$7
  , has            = require$$2$3
  , Iterators      = require$$1$17
  , $iterCreate    = require$$3$6
  , setToStringTag = require$$3$5
  , getPrototypeOf = require$$1$18
...
var require$$1$20 = (_stringAt && typeof _stringAt === 'object' && 'default' in _stringAt ? _stringAt['default'] : _stringAt);

var es6_string_iterator = __commonjs(function (module) {
'use strict';
var $at  = require$$1$20(true);
...
var require$$1$16 = (iterator && typeof iterator === 'object' && 'default' in iterator ? iterator['default'] : iterator);
...
var ITERATOR     = require$$0$6('iterator')
  , SAFE_CLOSING = false;
...
var require$$1$21 = (_task && typeof _task === 'object' && 'default' in _task ? _task['default'] : _task);

var _microtask = __commonjs(function (module) {
var global    = require$$1$2
  , macrotask = require$$1$21.set
...
var require$$9 = (_forOf && typeof _forOf === 'object' && 'default' in _forOf ? _forOf['default'] : _forOf);
...
var require$$10 = (_anInstance && typeof _anInstance === 'object' && 'default' in _anInstance ? _anInstance['default'] : _anInstance);
...
var LIBRARY            = require$$17$1
  ...
  , isObject           = require$$3$1
  , aFunction          = require$$1$15
  , anInstance         = require$$10
  , forOf              = require$$9
  , speciesConstructor = require$$8$1
  , task               = require$$1$21.set
  , microtask          = require$$6()
  , PROMISE            = 'Promise'
...
var USE_NATIVE = !!function(){
  try {
    ...
    var promise     = $Promise.resolve(1)
      , FakePromise = (promise.constructor = {})[require$$0$6('species')] = function(exec){ exec(empty, empty); };
...
var require$$1$22 = (create && typeof create === 'object' && 'default' in create ? create['default'] : create);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = require$$1$14(Function.call, require$$0$13.f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var DataLoader = function () {
  ...
  _createClass(DataLoader, [{
    ...
    value: function () {
      var _ref = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(subjects, fromDate, toDate) {
    ...
    key: 'getSubjects',
    value: function () {
      var _ref2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(amount, position, referenceSubj, fromDate, toDate) {
        var params, subjectsLoaded;
    ...
    key: 'load',
    value: function () {
      var _ref3 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3(params, ajaxFunc) {
...
var ModuleCoordinator = function () {
  ...
  _createClass(ModuleCoordinator, [{
    ...
    key: 'setStartDate',
    value: function () {
      var _ref3 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3(date) {
        var newEndDate;
        return _regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
    ...
    key: 'setDateRange',
    value: function () {
      var _ref4 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee4(fromDate, toDate) {
    ...
    key: 'setSubjectCount',
    value: function () {
      var _ref5 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee5(count) {
    ...
    key: 'addSubjects',
    value: function () {
      var _ref6 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee6(amount, position) {
