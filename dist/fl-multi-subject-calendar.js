...
var require$$0 = (_replacer && typeof _replacer === 'object' && 'default' in _replacer ? _replacer['default'] : _replacer);
...
var require$$3 = (_aFunction && typeof _aFunction === 'object' && 'default' in _aFunction ? _aFunction['default'] : _aFunction);
...
var require$$6$1 = (_iterators && typeof _iterators === 'object' && 'default' in _iterators ? _iterators['default'] : _iterators);
...
var require$$0$3 = (_sharedKey && typeof _sharedKey === 'object' && 'default' in _sharedKey ? _sharedKey['default'] : _sharedKey);
...
var require$$0$4 = (_defined && typeof _defined === 'object' && 'default' in _defined ? _defined['default'] : _defined);
...
var require$$2$2 = (_toObject && typeof _toObject === 'object' && 'default' in _toObject ? _toObject['default'] : _toObject);
...
var require$$0$6 = (_enumBugKeys && typeof _enumBugKeys === 'object' && 'default' in _enumBugKeys ? _enumBugKeys['default'] : _enumBugKeys);
...
var require$$3$1 = (_toInteger && typeof _toInteger === 'object' && 'default' in _toInteger ? _toInteger['default'] : _toInteger);
...
var require$$0$9 = (_toLength && typeof _toLength === 'object' && 'default' in _toLength ? _toLength['default'] : _toLength);
...
var require$$10$1 = (_cof && typeof _cof === 'object' && 'default' in _cof ? _cof['default'] : _cof);
...
var require$$0$10 = (_toIobject && typeof _toIobject === 'object' && 'default' in _toIobject ? _toIobject['default'] : _toIobject);
...
var require$$0$7 = (_objectDps && typeof _objectDps === 'object' && 'default' in _objectDps ? _objectDps['default'] : _objectDps);
...
var require$$0$5 = (_iterCreate && typeof _iterCreate === 'object' && 'default' in _iterCreate ? _iterCreate['default'] : _iterCreate);
...
var require$$0$2 = (_iterDefine && typeof _iterDefine === 'object' && 'default' in _iterDefine ? _iterDefine['default'] : _iterDefine);
...
var require$$3$2 = (_iterStep && typeof _iterStep === 'object' && 'default' in _iterStep ? _iterStep['default'] : _iterStep);
...
var require$$0$11 = (_addToUnscopables && typeof _addToUnscopables === 'object' && 'default' in _addToUnscopables ? _addToUnscopables['default'] : _addToUnscopables);
...
var require$$7 = (es6_array_iterator && typeof es6_array_iterator === 'object' && 'default' in es6_array_iterator ? es6_array_iterator['default'] : es6_array_iterator);
...
var require$$0$12 = (_invoke && typeof _invoke === 'object' && 'default' in _invoke ? _invoke['default'] : _invoke);
...
var require$$0$13 = (_partial && typeof _partial === 'object' && 'default' in _partial ? _partial['default'] : _partial);
...
var require$$2$4 = (_classof && typeof _classof === 'object' && 'default' in _classof ? _classof['default'] : _classof);
...
var require$$1$8 = (core_getIteratorMethod && typeof core_getIteratorMethod === 'object' && 'default' in core_getIteratorMethod ? core_getIteratorMethod['default'] : core_getIteratorMethod);

var _isArrayIter = __commonjs(function (module) {
// check on default Array iterator
var Iterators  = require$$6$1
  , ITERATOR   = require$$19('iterator')
  , ArrayProto = Array.prototype;
...
var require$$9$1 = (_forOf && typeof _forOf === 'object' && 'default' in _forOf ? _forOf['default'] : _forOf);
...
var require$$10$2 = (_anInstance && typeof _anInstance === 'object' && 'default' in _anInstance ? _anInstance['default'] : _anInstance);
...
var require$$6$2 = (_microtask && typeof _microtask === 'object' && 'default' in _microtask ? _microtask['default'] : _microtask);

var es7_observable = __commonjs(function (module) {
'use strict';
// https://github.com/zenparsing/es-observable
var $export     = require$$26
  , global      = require$$29
  , core        = require$$1
  , microtask   = require$$6$2()
  , OBSERVABLE  = require$$19('observable')
  , aFunction   = require$$3
  , anObject    = require$$13
  , anInstance  = require$$10$2
...
var require$$9$2 = (_inheritIfRequired && typeof _inheritIfRequired === 'object' && 'default' in _inheritIfRequired ? _inheritIfRequired['default'] : _inheritIfRequired);
...
var require$$1$11 = (_arrayMethods && typeof _arrayMethods === 'object' && 'default' in _arrayMethods ? _arrayMethods['default'] : _arrayMethods);
...
var redefineAll       = require$$4$2
  ...
  , anInstance        = require$$10$2
  , forOf             = require$$9$1
  , createArrayMethod = require$$1$11
  , $has              = require$$28
...
var require$$1$10 = (_collectionWeak && typeof _collectionWeak === 'object' && 'default' in _collectionWeak ? _collectionWeak['default'] : _collectionWeak);

var _objectGops = __commonjs(function (module, exports) {
exports.f = Object.getOwnPropertySymbols;
});

var require$$1$12 = (_objectGops && typeof _objectGops === 'object' && 'default' in _objectGops ? _objectGops['default'] : _objectGops);
...
var require$$1$13 = (_collectionStrong && typeof _collectionStrong === 'object' && 'default' in _collectionStrong ? _collectionStrong['default'] : _collectionStrong);

var es6_map = __commonjs(function (module) {
'use strict';
var strong = require$$1$13;
...
var require$$3$3 = (es6_map && typeof es6_map === 'object' && 'default' in es6_map ? es6_map['default'] : es6_map);
...
var require$$4$3 = (es6_set && typeof es6_set === 'object' && 'default' in es6_set ? es6_set['default'] : es6_set);
...
module.exports = require$$1$7|| !require$$23(function(){
  var K = Math.random();
...
var require$$2$5 = (_createProperty && typeof _createProperty === 'object' && 'default' in _createProperty ? _createProperty['default'] : _createProperty);
...
var require$$4$4 = (_objectGopn && typeof _objectGopn === 'object' && 'default' in _objectGopn ? _objectGopn['default'] : _objectGopn);

var _ownKeys = __commonjs(function (module) {
// all object keys, includes non-enumerable and symbols
var gOPN     = require$$4$4
  , gOPS     = require$$1$12
  , anObject = require$$13
...
var require$$1$14 = (_isRegexp && typeof _isRegexp === 'object' && 'default' in _isRegexp ? _isRegexp['default'] : _isRegexp);
...
var _stringWs = __commonjs(function (module) {
...
var require$$3$4 = (_stringTrim && typeof _stringTrim === 'object' && 'default' in _stringTrim ? _stringTrim['default'] : _stringTrim);
...
var require$$1$15 = (_stringRepeat && typeof _stringRepeat === 'object' && 'default' in _stringRepeat ? _stringRepeat['default'] : _stringRepeat);
...
var $export    = require$$26
  ...
  , fails      = require$$23
  , bind       = require$$0$30
  , rConstruct = (require$$29.Reflect || {}).construct;
...
var $export   = require$$26
  , aFunction = require$$3
  , anObject  = require$$13
  , rApply    = (require$$29.Reflect || {}).apply
...
var require$$1$17 = (_arrayCopyWithin && typeof _arrayCopyWithin === 'object' && 'default' in _arrayCopyWithin ? _arrayCopyWithin['default'] : _arrayCopyWithin);
...
var require$$1$18 = (_arrayFill && typeof _arrayFill === 'object' && 'default' in _arrayFill ? _arrayFill['default'] : _arrayFill);
...
var require$$9$3 = (_typed && typeof _typed === 'object' && 'default' in _typed ? _typed['default'] : _typed);
...
var require$$8$2 = (_typedBuffer && typeof _typedBuffer === 'object' && 'default' in _typedBuffer ? _typedBuffer['default'] : _typedBuffer);

var _typedArray = __commonjs(function (module) {
'use strict';
if(require$$27){
  var LIBRARY             = require$$1$7
    , global              = require$$29
...
var $export = require$$26;
$export($export.G + $export.W + $export.F * !require$$9$3.ABV, {
  DataView: require$$8$2.DataView
});
});
...
$export($export.P, 'Array', {fill: require$$1$18});
...
$export($export.P, 'Array', {copyWithin: require$$1$17});
...
var require$$1$19 = (_arrayReduce && typeof _arrayReduce === 'object' && 'default' in _arrayReduce ? _arrayReduce['default'] : _arrayReduce);
...
var require$$1$20 = (_stringContext && typeof _stringContext === 'object' && 'default' in _stringContext ? _stringContext['default'] : _stringContext);
...
var require$$0$43 = (_isInteger && typeof _isInteger === 'object' && 'default' in _isInteger ? _isInteger['default'] : _isInteger);

var es6_number_isSafeInteger = __commonjs(function (module) {
// 20.1.2.5 Number.isSafeInteger(number)
var $export   = require$$26
  , isInteger = require$$0$43
  , abs       = Math.abs;
...
$export($export.S, 'Number', {isInteger: require$$0$43});
});
...
var _aNumberValue = __commonjs(function (module) {
var cof = require$$10$1;
...
var require$$2$6 = (_aNumberValue && typeof _aNumberValue === 'object' && 'default' in _aNumberValue ? _aNumberValue['default'] : _aNumberValue);
...
var require$$8$3 = (_objectGopnExt && typeof _objectGopnExt === 'object' && 'default' in _objectGopnExt ? _objectGopnExt['default'] : _objectGopnExt);

var es6_object_getOwnPropertyNames = __commonjs(function (module) {
// 19.1.2.7 Object.getOwnPropertyNames(O)
require$$0$44('getOwnPropertyNames', function(){
  return require$$8$3.f;
});
});
...
if(!USE_NATIVE){
  ...
  $DP.f   = $defineProperty;
  require$$4$4.f = gOPNExt.f = $getOwnPropertyNames;
  require$$0$18.f  = $propertyIsEnumerable;
  require$$1$12.f = $getOwnPropertySymbols;
...
var LabelsBar = function (_ViewController) {
  ...
  function LabelsBar(modulePrefix) {
    ...
    var _this = possibleConstructorReturn(this, Object.getPrototypeOf(LabelsBar).call(this, modulePrefix));
...
var ControlBar = function (_ViewController) {
  ...
  function ControlBar(moduleCoordinator, modulePrefix) {
    ...
    var _this = possibleConstructorReturn(this, Object.getPrototypeOf(ControlBar).call(this, modulePrefix));
...
var DateBar = function (_ViewController) {
  ...
  function DateBar(startDate, modulePrefix) {
    ...
    var _this = possibleConstructorReturn(this, Object.getPrototypeOf(DateBar).call(this, modulePrefix, CLASS_PREFIX$1));
...
var SubjectRow = function (_ViewController) {
  ...
  function SubjectRow(subject, rowStartDate, rowEndDate, modulePrefix) {
    ...
    var _this = possibleConstructorReturn(this, Object.getPrototypeOf(SubjectRow).call(this, modulePrefix));
...
var DatesPanel = function (_ViewController) {
  ...
  function DatesPanel(startDate, modulePrefix) {
    ...
    var _this = possibleConstructorReturn(this, Object.getPrototypeOf(DatesPanel).call(this, modulePrefix, CLASS_PREFIX));
...
var CalendarContainer = function (_ViewController) {
  ...
  function CalendarContainer(modulePrefix) {
    ...
    var _this = possibleConstructorReturn(this, Object.getPrototypeOf(CalendarContainer).call(this, modulePrefix));
...
var Legend = function (_ViewController) {
  ...
  function Legend(modulePrefix) {
    ...
    var _this = possibleConstructorReturn(this, Object.getPrototypeOf(Legend).call(this, modulePrefix));
